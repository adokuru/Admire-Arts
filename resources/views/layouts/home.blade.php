...
<head>
    ...
    <meta property="og:title" content="Brilliant Brushes - Discover &amp; Buy Art" />
...
<body>
    <div class="boxed_wrapper">
                ...
                <div class="container">
                    <div class="outer-box clearfix">
                        ...
                        <div class="header-top-right float-right">
                            <div class="phone-num">
                                <a href="tel:1309-650-1352">Phone:+44 (0) 744 144 3572</a>
                            </div>
                        </div>
                    </div>
                </div>
                                ...
                                <nav class="main-menu navbar-expand-lg">
                                    ...
                                    <div class="navbar-collapse collapse clearfix" id="navbarSupportedContent">
                                        <ul class="navigation clearfix">
                                            ...
                                            <li>
                                                <a href="/view-rooms">Viewing Rooms</a>
                                            </li>
                                            <li>
                                                ...
                                                <form method="post" action="/search">
                                                    ...
                                                    <div class="form-group">
                                                        <input type="search" name="search"
                                                            placeholder="Search for Arts" required />
                                                        <button type="submit">
                                                            <i class="fa fa-search"></i>
                                                        </button>
                                                    </div>
        ...
        <footer class="footer-style2-area chnage-bg-style">
            <div class="layer-outer-bg"
                style="background-image:url(images/parallax-background/footer-style4-bg.jpg);"></div>
            <div class="footer">
                <div class="container">
                    <div class="row">
                        <!--Start single footer widget-->
                        <div class="col-xl-3 col-lg-4 col-md-4 col-sm-12 wow fadeInUp animated" data-wow-delay="100ms"
                            ...
                            <div class="single-footer-widget clr-white marbtm50">
                                ...
                                <div class="text">
                                    Brilliant Brushes is a world’s leading galleries, museum collections, foundations,
                                    artist estates, art fairs, and benefit auctions, all in one place.
                                </div>
                            </div>
                        </div>
                        <!--End single footer widget-->
                        <!--Start single footer widget-->
                        <div class="col-xl-2 col-lg-4 col-md-4 col-sm-12 wow fadeInUp animated" data-wow-delay="100ms"
                            style="visibility: visible; animation-delay: 100ms; animation-name: fadeInUp;">
                            <div class="single-footer-widget clr-white marbtm50">
                                <div class="title">
                                    <h3>Extra :-</h3>
                                ...
                                <ul class="social-links">
                                    <li><a href="http://www.twitter.com/share?url={{ Request::url() }}">Twitter</a>
                                    </li>
                        ...
                        <div class="col-xl-3 col-lg-4 col-md-4 col-sm-12 wow fadeInUp animated" data-wow-delay="100ms"
                            ...
                            <div class="single-footer-widget clr-white">
                                ...
                                <div class="contact-us">
                                    <p>
                                        160 Victoria Street London,<br />
                                        SW1E 5LB, UK
                                    </p>
                                    <div class="phone-num">
                                        <a href="tel:+447441443572">+44 (0) 744 144 3572</a>
                                    </div>
                                </div>
                            </div>
                        </div>
                        <!--End single footer widget-->
                        <!--Start single footer widget-->
                        <div class="col-xl-2 col-lg-8 col-md-8 col-sm-12 wow fadeInUp animated" data-wow-delay="100ms"
                            style="visibility: visible; animation-delay: 100ms; animation-name: fadeInUp;">
                            ...
                            <div class="single-footer-widget clr-white follow-sociallinks-widget-box">
                                ...
                                <div class="footer-social-links">
                                    <ul class="social-links-style1">
                                        ...
                                        <li>
                                            <a href="http://www.twitter.com/share?url={{ Request::url() }}"><i
                                                    class="fa fa-twitter" aria-hidden="true"></i></a>
                                        </li>
                                        <li>
                                            <a href="mailto:info@brilliantbrushes.co.uk"><i class="fa fa-envelope"
