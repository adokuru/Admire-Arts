@extends('layouts/home') @section('title')
    {{ $art->name }}
                        ...
                        <h2>
                            ...
                            <div class="zoom-button">
                                <a class="lightbox-image" data-fancybox="gallery"
                                    href="{{ asset($art->art_file_path) }}">View
                    ...
                    <div class="events-single-info-box">
                        <ul class="events-info">
                            ...
                            <li>
                                ...
                                <button type="button" class="btn-one" data-toggle="modal"
                        ...
                        <div class="social-links">
                            ...
                            <ul class="sociallinks-style-two">
                                <li>
                                    <a href="https://www.facebook.com/sharer/sharer.php?u={{ Request::url() }}"><i
                                ...
                                <li>
                                    <a href="mailto:info@admireart.com"><i class="fa fa-envelope"
                ...
                <div class="col-xl-4">
                    <div class="single-events-detais-box">
                        ...
                        <ul>
                            ...
                            <li>
                                <span>ADDRESS:</span>160 Victoria Street London,<br />
                                SW1E 5LB, UK<br>
                            </li>
                            <li>
                                <span>PHONE:</span><a href="tel:+447441443572">+44 (0) 744 144 3572</a>
                            </li>
                        </ul>
                    </div>
                </div>
                ...
                <div class="col-xl-4">
                    <div class="single-events-detais-box">
                        ...
                        <ul>
                            ...
                            <li>
                                <span>ORGANIZER NAME:</span>Admire Arts
                            </li>
                            <li>
                ...
                <div class="modal-body">
                    <form method="POST" action="{{ route('Artcontact') }}" id="buy-form">
                        ...
                        <div class="scontact-artwork-details">
                            ...
                            <p>{{ $art->name }}</p>
                            <p><em>{{ $art->artist->DisplayName }}</em></p>
                        </div>
                        <div class="input-box form-group">
                            <input class="form-control" type="hidden" name="form_art" value="{{ $art->id }}"
                                placeholder="Full Name" required>
                        </div>
                        <div class="input-box form-group">
                            <label for="message-text" class="col-form-label">Message:</label>
                            <textarea class="form-control" rows="4" id="message-text" name="form_message" placeholder="Your Message..."
                                required="" aria-required="true">Hi, I’m interested in purchasing this work. Could you please provide more information about the piece?
                    </textarea>
                        </div>
                        <div class="input-box form-group">
