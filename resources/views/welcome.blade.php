...
<html lang="en">
    <head>
        <meta charset="UTF-8" />
        <title>Admire Arts - Discover &amp; Buy Art</title>
        <meta
            property="og:title"
    ...
    <body>
        <div class="boxed_wrapper">
            ...
            <section class="main-slider style1">
                ...
                <!--Scroll Dwwn Btn-->
                <div
                    class="mouse-btn-down scroll-to-explore"
                    data-target=".exhibitions-area"
                ></div>
            </section>
            <!--End Main Slider-->
            ...
            <section class="exhibitions-area">
                <div class="container">
                    ...
                    <div class="row masonary-layout">
                        ...
                        <div
                            class="col-xl-4 col-lg-6 col-md-6 col-sm-12 wow fadeInUp"
                        >
                            <div class="single-exhibition-box">
                                <div class="img-holder">
                                    <img
                                        src="images/art/300/2623008-QBFZDQLC-25.jpg"
                                        alt="Awesome Image"
                                    />
                                    <div class="overlay-style-one bg1">
                                        <div class="zoom-button">
                                            <a
                                                ...
                                                href="images/art/300/2623008-QBFZDQLC-25.jpg"
                                            >
                                                <i
                                ...
                                <div class="text-holder text-center">
                                    ...
                                    <h2>
                                        <a href="#"
                                            >The Museum is Located in St-
                                            Germain Castle</a
                                        >
                                    </h2>
                                    <p>From 6 Sept 2018 until 7 Jan 2019</p>
                                    <div class="button">
                                        <div class="inner">
                                            <a class="btn-one" href="#">View</a>
                                        </div>
                                    </div>
                                </div>
                            </div>
                        ...
                        >
                            <div class="single-exhibition-box">
                                <div class="img-holder">
                                    <img
                                        src="images/art/eastvil/download.jpg"
                                        alt="Awesome Image"
                                    />
                                    <div class="overlay-style-one bg1">
                                        <div class="zoom-button">
                                            <a
                                                class="lightbox-image"
                                                data-fancybox="gallery"
                                                href="images/art/eastvil/download.jpg"
                                            >
                                                <i
                                                    class="fa fa-search-plus"
                                                    aria-hidden="true"
                                ...
                                <div class="text-holder text-center">
                                    ...
                                    <h2>
                                        <a href="#"
                                            >Healing Arts with Memory, Meaning
                                            and Might</a
                                        >
                                    </h2>
                                    <p>From 16 NOV, 2018 Until 7 Jan 2019</p>
                                    <div class="button">
                                        <div class="inner">
                                            <a class="btn-one" href="#">View</a>
                                        </div>
                        ...
                        >
                            <div class="single-exhibition-box">
                                <div class="img-holder">
                                    <img
                                        src="images/resources/exhibition-3.jpg"
                                        alt="Awesome Image"
                                    />
                                    <div class="overlay-style-one bg1">
                                        <div class="zoom-button">
                                            <a
                                                class="lightbox-image"
                                                data-fancybox="gallery"
                                                href="images/resources/exhibition-3.jpg"
                                            >
                                                <i
                                                    class="fa fa-search-plus"
                                                    aria-hidden="true"
                        ...
                        >
                            <div class="single-exhibition-box">
                                <div class="img-holder">
                                    <img
                                        src="images/art/375/2266847-KQXURFEN-6.jpg"
                                        alt="Awesome Image"
                                    />
                                    <div class="overlay-style-one bg1">
                                        <div class="zoom-button">
                                            <a
                                                class="lightbox-image"
                                                data-fancybox="gallery"
                                                href="images/art/375/2266847-KQXURFEN-6.jpg"
                                            >
                                                <i
                                                    class="fa fa-search-plus"
                                                    aria-hidden="true"
                        ...
                        >
                            <div class="single-exhibition-box">
                                <div class="img-holder">
                                    <img
                                        src="images/art/375/899672-6.jpg"
                                        alt="Awesome Image"
                                    />
                                    <div class="overlay-style-one bg1">
                                        <div class="zoom-button">
                                            <a
                                                class="lightbox-image"
                                                data-fancybox="gallery"
                                                href="images/art/375/899672-6.jpg"
                                            >
                                                <i
                                                    class="fa fa-search-plus"
                                                    aria-hidden="true"
                                ...
                                <div class="text-holder text-center">
                                    ...
                                    <h2>
                                        <a href="#"
                                            >The Pre-Raphaelites at the National
                                            Gallery</a
                                        >
                                    </h2>
                                    <p>From 16 NOV, 2018 Until 7 Jan 2019</p>
                        ...
                        >
                            <div class="single-exhibition-box">
                                <div class="img-holder">
                                    <img
                                        src="images/art/375/6345067-HHHCBAZE-6.jpg"
                                        alt="Awesome Image"
                                    />
                                    <div class="overlay-style-one bg1">
                                        <div class="zoom-button">
                                            <a
                                                class="lightbox-image"
                                                data-fancybox="gallery"
                                                href="images/art/375/6345067-HHHCBAZE-6.jpg"
                                            >
                                                <i
                                                    class="fa fa-search-plus"
                                                    aria-hidden="true"
            ...
            <section class="fact-counter-area">
                <div class="container">
                    <div class="sec-title text-center">
                        <p>
                            Everything about our organization in numerical
                            counter view.
                        </p>
                        <div class="big-title">
                            <h1>
                    ...
                    <div class="row">
                        ...
                        <div class="col-xl-3 col-lg-6 col-md-6 col-sm-12">
                            ...
                            >
                                <div class="icon">
                                    <img
                                        src="images/icon/fact-counter-1.png"
                                        alt="Icon"
                                    />
                                </div>
                                <div class="count-box">
                        ...
                        <div class="col-xl-3 col-lg-6 col-md-6 col-sm-12">
                            ...
                            >
                                <div class="icon">
                                    <img
                                        src="images/icon/fact-counter-2.png"
                                        alt="Icon"
                                    />
                                </div>
                                <div class="count-box">
                        ...
                        <div class="col-xl-3 col-lg-6 col-md-6 col-sm-12">
                            ...
                            >
                                <div class="icon">
                                    <img
                                        src="images/icon/fact-counter-3.png"
                                        alt="Icon"
                                    />
                                </div>
                                <div class="count-box">
                        ...
                        <div class="col-xl-3 col-lg-6 col-md-6 col-sm-12">
                            ...
                            >
                                <div class="icon">
                                    <img
                                        src="images/icon/fact-counter-4.png"
                                        alt="Icon"
                                    />
                                </div>
                                <div class="count-box">
                            ...
                            <div class="latest-blog-title">
                                ...
                                <div class="text">
                                    <p>
                                        ...
                                        Publication on your Update work. if
                                        you<br />
                            ...
                            >
                                    ...
                                    <div class="text-holder">
                                        ...
                                        <h3 class="blog-title">
                                            <a href="blog-single.html"
                                                >Looking Forward: The Phasrasth
                                                and Kenyard</a
                                            >
                                        </h3>
                                        <div class="text">
                                            Her tricky smile and timeless allure
                                            have inspired academic study &
                                            artistic emulation for more than
                                            five once and
                                        </div>
                                ...
                                >
                                    ...
                                    <div class="text-holder">
                                        ...
                                        <h3 class="blog-title">
                                            <a href="blog-single.html"
                                                >Scenes from Stepan Hawkin’s
                                                World</a
                                            >
                                        </h3>
                                        <div class="text">
                                            In a 1982 essay, Halley wrote that
                                            the idealist square becomes the
                                            prison made Geoetry is revealed as
                                            confinementIn other
                                        </div>
                                        <div class="button-box">
                                            <a href="blog-single.html"
                    ...
                    <div class="row">
                        <div class="col-xl-6">
                            <div class="subscribe-title">
                                ...
                                <span
                                    >Receive e-mail updates on our exhibitions,
                                    events, and more........</span
                                >
                            </div>
                        </div>
                        <div class="col-xl-6">
